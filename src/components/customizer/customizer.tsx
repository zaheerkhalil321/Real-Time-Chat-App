...
interface CustomizerProps {
   ...
   handleCollapsedSidebar: (state: boolean) => void,
   sidebarBgColor: (color: string) => void,
   sidebarImageUrl: (color: string) => void
}
class Customizer extends Component<CustomizerProps, CustomizerState> {
   ...
   handleLayout = (layout: string) => {
      this.props.handleLayout(layout);
   };

   handleSidebarChange = (state: boolean) => {
                                 ...
                                 <FormGroup check>
                                    <Label check>
                                       <Input
                                          ...
                                          onChange={e => {
                                             if (e.target.checked === true) {
                                                (context as any).makeNormalContent();
                                                this.handleSidebarChange(false);
                                             } else {
                                                (context as any).makeFullContent();
